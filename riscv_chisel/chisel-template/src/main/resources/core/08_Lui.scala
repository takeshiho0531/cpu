...
val imm_u = inst(31, 12) // 追加
val imm_u_shifted = Cat(imm_u, Fill(12, 0.U))  // 追加
...
val csignals = ListLookup(inst,
    ...
    Array(
        ...
        LUI -> List(ALU_ADD, OP1_X, OP2_IMU, MEN_X, REN_S, WB_ALU),  // 追加
        AUIPC -> List(ALU_ADD, OP1_PC, OP2_IMU, MEN_X, REN_S, WB_ALU)  // 追加
    )
)
